...
export default function AICopilotPage() {
  ...
  return (
    <Layout>
      ...
      description="Transform your business processes and drive innovation with cutting-edge AI technologies"
    ...
    >
      ...
      <section className="mb-20">
        <AnimatedElement>
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12">AI Implementation Process</h2>
        </AnimatedElement>
